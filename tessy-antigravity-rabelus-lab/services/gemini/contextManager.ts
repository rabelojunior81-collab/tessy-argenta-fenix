// biome-ignore lint/complexity/noStaticOnlyClass: interface mantida para compatibilidade futura
export class ContextManager {
   ...
   */
  static async syncContext(
    _files: { path: string; content: string; mimeType: string }[]
  ): Promise<string | null> {
    // [TESSERACT CLEANUP]
