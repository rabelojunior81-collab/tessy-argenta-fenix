...
export type BrokerBindingStatus = 'unregistered' | 'registered' | 'invalid' | 'unavailable';
...
export interface Workspace {
  ...
  brokerStatus?: BrokerBindingStatus;
  brokerValidatedAt?: number;
  brokerRegisteredAt?: number;
  lastSyncAt: number;
