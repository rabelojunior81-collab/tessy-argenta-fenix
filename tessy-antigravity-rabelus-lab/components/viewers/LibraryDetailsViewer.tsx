import { ChevronRight, Code, Edit3, Save, Undo2, X } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-2 space-y-3">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  <label
                    htmlFor="ldv-label"
                    className="text-[10px] font-bold text-glass-muted uppercase tracking-widest"
                  >
                    Nome do Protocolo
                  </label>
                  <input
                ...
                <div className="space-y-2">
                  ...
                  <select
                    ...
                    className="w-full glass-input p-2.5 text-xs font-normal text-glass uppercase focus:border-glass-accent outline-none"
                  >
                    <option value="Código" className="bg-black">
                      Código
                    </option>
                    <option value="Escrita" className="bg-black">
                      Escrita
                    </option>
                    <option value="Análise" className="bg-black">
                      Análise
                    </option>
                    <option value="Ensino" className="bg-black">
                      Ensino
                    </option>
                    <option value="Criativo" className="bg-black">
                      Criativo
                    </option>
                    <option value="Personalizado" className="bg-black">
                      Personalizado
                    </option>
                  </select>
                </div>
          ...
          <div className="flex-1 flex flex-col overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto custom-scrollbar p-2">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h4 className="text-[10px] font-bold text-glass-muted uppercase tracking-[0.2em]">
                  Núcleo do Protocolo
                </h4>
              </div>
