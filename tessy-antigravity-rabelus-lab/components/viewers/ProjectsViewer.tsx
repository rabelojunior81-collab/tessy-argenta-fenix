      ...
      <div className="px-2 py-1 flex items-center gap-1 glass-header glass-header-compact">
        ...
        {isLoading && projects.length > 0 && (
          <Loader2
            ...
            aria-label="Sincronizando projetos"
          />
        )}
      </div>
      ...
      >
        {isLoading && projects.length === 0 ? (
          ...
          filteredProjects.map((project) => {
            ...
            return (
              // biome-ignore lint/a11y/noStaticElementInteractions lint/a11y/useKeyWithClickEvents: project list row
              <div
                role="presentation"
                key={project.id}
                ...
                style={{
                  backgroundColor:
                    isActive && !isConfirming ? 'rgba(var(--accent-rgb), 0.12)' : undefined,
                  borderColor:
                    isActive && !isConfirming ? 'rgba(var(--accent-rgb), 0.3)' : undefined,
                }}
              ...
              >
                <div className="flex justify-between items-start gap-2 mb-0.5">
                  <div className="flex items-center gap-2 overflow-hidden flex-1">
                    ...
                    <h4
                      style={{
                        color: !isConfirming && isActive ? 'var(--glass-accent)' : undefined,
                      }}
