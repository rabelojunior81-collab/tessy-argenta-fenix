import { Activity, Database, FileText, Github, Layout, Library, Play, X } from 'lucide-react';
...
const ProjectDetailsViewer: React.FC<ProjectDetailsViewerProps> = ({
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: loadData is intentionally defined outside useCallback for simplicity; runs on projectId change only
  useEffect(() => {
    loadData();
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4">
        <div className="flex flex-col items-center justify-start text-center space-y-3">
          ...
          <div className="flex flex-col items-center mt-1">
            ...
            <p className="text-[10px] text-glass-muted/60 uppercase tracking-widest font-mono">
          ...
          <div className="flex items-center gap-2 pt-1">
            ...
            <div className="relative">
              ...
              >
                <FileText
                  size={12}
                  className={isGenerating ? 'animate-pulse text-glass-accent' : ''}
                />
              </button>
              {showDocMenu && (
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-1 w-24 glass-card border border-glass-border shadow-xl z-50 py-1">
                  <button
                    ...
                    className="w-full px-2 py-1 text-[8px] font-bold uppercase text-glass hover:bg-white/10 text-left"
                  >
                    README
                  </button>
                  <button
