        ...
        <form onSubmit={handleSubmit} className="p-3 space-y-3">
          <div className="space-y-1">
            <label
              ...
              className="text-[9px] font-bold text-glass-muted uppercase tracking-widest"
            >
              Identificação
            </label>
            <input
          ...
          {isSupported && (
            <div className="space-y-1">
              <span className="text-[9px] font-bold text-glass-muted uppercase tracking-widest flex items-center gap-1">
                <FolderOpen size={10} />
                Workspace Local
              </span>
              <div className="glass-input p-2 flex items-center justify-between">
                {currentWorkspace ? (
                  <div className="flex items-center gap-2 flex-1 min-w-0">
                    <div
                      className={`w-1.5 h-1.5 rounded-full ${currentWorkspace.status === 'connected' ? 'bg-green-400' : 'bg-yellow-400'}`}
                    />
                    <span className="text-[9px] font-mono text-glass truncate">
