...
const ShareModal: React.FC<ShareModalProps> = ({ isOpen, onClose, conversation }) => {
  ...
  }, [isOpen, conversation, handleGenerateCode]);
        ...
        <div className="p-3 flex flex-col items-center text-center space-y-3">
          {isGenerating ? (
            ...
            <div className="w-full space-y-3 animate-fade-in">
              <p className="text-[8px] text-glass-muted font-bold uppercase tracking-widest">
                Código:
              </p>
              <div className="py-2 glass-card border-glass/10 bg-white/5 relative group overflow-hidden">
                ...
                <span className="text-lg font-bold text-glass font-mono tracking-[0.2em] uppercase relative z-10">
                  {code}
                </span>
              </div>
              <button
