      ...
      >
            ...
            <div className="space-y-2 animate-fade-in">
              <div className="grid grid-cols-2 gap-2">
                <div className="px-2 py-1.5 glass-card text-center flex items-center justify-between border-glass/10">
                  ...
                  <span style={{ color: 'var(--glass-accent)' }} className="text-sm font-bold">
                    {result.clarity_score.toFixed(1)}
                  </span>
                </div>
                <div className="px-2 py-1.5 glass-card text-center flex items-center justify-between border-glass/10">
                  <span className="text-[8px] font-bold text-glass-muted uppercase tracking-widest">
        ...
        <div className="p-2 glass-header glass-header-compact flex gap-2 shrink-0">
          ...
          <button
            ...
            className={`flex-1 py-1 font-bold uppercase tracking-widest text-[8px] transition-all flex items-center justify-center gap-1 active:scale-95 ${
              !result
