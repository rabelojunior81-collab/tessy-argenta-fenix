import { ChevronDown, RotateCcw, Settings2, Sparkles, X } from 'lucide-react';
      ...
      >
        ...
        <div className="flex border-b border-glass shrink-0">
          <button
            ...
            className={`flex-1 py-1.5 text-[9px] font-bold tracking-widest transition-all relative uppercase ${
              activeTab === 'settings'
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar px-3 py-2 space-y-2 max-h-[50vh]">
          {activeTab === 'settings' ? (
                    ...
                    {factor.type === 'toggle' && (
                      <>
                        ...
                        <button
                          ...
                          className={`w-7 h-3.5 transition-all flex items-center px-0.5 ${
                            factor.enabled
                  ...
                  {factor.type === 'slider' && (
                    <div className="flex items-center gap-2 glass-card border-glass/10 py-1.5 px-2">
                      <input
                        ...
                        max={factor.max}
                        value={factor.value}
                        onChange={(e) => updateFactor(factor.id, parseInt(e.target.value, 10))}
                      ...
                      />
                      <span className="text-[9px] font-mono font-bold text-glass-accent w-4 text-right">
                        {factor.value}
                      </span>
                    </div>
                  )}
            ...
            <div className="h-32 flex flex-col items-center justify-center text-center opacity-20">
              ...
              <p className="text-[8px] font-bold uppercase tracking-widest text-glass-muted">
                Offline
              </p>
            </div>
          )}
