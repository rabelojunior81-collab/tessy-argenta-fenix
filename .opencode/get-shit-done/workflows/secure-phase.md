...
```
Task(
  prompt="Read E:/tessy-argenta-fenix/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/tessy-argenta-fenix/.opencode/get-shit-done/templates/SECURITY.md`
