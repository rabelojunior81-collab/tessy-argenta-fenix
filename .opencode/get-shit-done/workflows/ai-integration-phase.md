...
<required_reading>
@E:/tessy-argenta-fenix/.opencode/get-shit-done/references/ai-frameworks.md
@E:/tessy-argenta-fenix/.opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read E:/tessy-argenta-fenix/.opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "E:/tessy-argenta-fenix/.opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read E:/tessy-argenta-fenix/.opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read E:/tessy-argenta-fenix/.opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read E:/tessy-argenta-fenix/.opencode/agents/gsd-eval-planner.md for instructions.
