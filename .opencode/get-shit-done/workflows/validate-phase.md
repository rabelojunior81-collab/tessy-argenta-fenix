...
```
Task(
  prompt="Read E:/tessy-argenta-fenix/.opencode/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/tessy-argenta-fenix/.opencode/get-shit-done/templates/VALIDATION.md`
