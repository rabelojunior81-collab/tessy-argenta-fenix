...
export const PROMPT_TEMPLATES: Template[] = [
  {
    ...
    description: 'Decompõe a anatomia do algoritmo em camadas compreensíveis, revelando a lógica por trás da sintaxe.',
  ...
  },
  {
    ...
    description: 'Um olhar clínico sobre o código para detectar vulnerabilidades, gargalos de performance e desvios de Clean Code.',
  ...
  },
  {
    ...
    category: 'Escrita',
    label: 'Revisar Texto',
    description: 'Esculpe a comunicação para máxima clareza e impacto, refinando o tom de voz e a gramática.',
  ...
  },
  {
    ...
    category: 'Escrita',
    label: 'Resumir',
    description: 'Extrai a essência quântica do conteúdo, condensando informações massivas em tópicos vitais.',
  ...
  },
  {
    ...
    description: 'Uma análise de equilíbrio entre forças e fraquezas, permitindo tomadas de decisão fundamentadas.',
  ...
  },
  {
    ...
    description: 'Traduz complexidades teóricas em analogias humanas poderosas para um aprendizado acelerado.',
  ...
  },
  {
    ...
    category: 'Criativo',
    label: 'Brainstorming',
    description: 'Quebra o bloqueio criativo com uma explosão de ideias divergentes e caminhos não lineares.',
