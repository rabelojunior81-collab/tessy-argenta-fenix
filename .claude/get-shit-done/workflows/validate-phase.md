...
```
Task(
  prompt="Read E:/tessy-argenta-fenix/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/tessy-argenta-fenix/.claude/get-shit-done/templates/VALIDATION.md`
