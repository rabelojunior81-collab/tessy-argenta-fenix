...
<template>
@E:/tessy-argenta-fenix/.claude/get-shit-done/templates/UAT.md
</template>
...
Read and follow `E:/tessy-argenta-fenix/.claude/get-shit-done/workflows/transition.md`.
...
```bash
node "E:/tessy-argenta-fenix/.claude/get-shit-done/bin/gsd-tools.cjs" audit-open --json 2>/dev/null
```
...
- Follow @E:/tessy-argenta-fenix/.claude/get-shit-done/workflows/diagnose-issues.md
