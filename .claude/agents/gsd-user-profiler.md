...
<reference>
@E:/tessy-argenta-fenix/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/tessy-argenta-fenix/.claude/get-shit-done/references/user-profiling.md` to load:
