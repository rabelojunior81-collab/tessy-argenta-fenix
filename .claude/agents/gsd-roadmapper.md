...
Reference full template: `E:/tessy-argenta-fenix/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/tessy-argenta-fenix/.claude/get-shit-done/templates/state.md`.
