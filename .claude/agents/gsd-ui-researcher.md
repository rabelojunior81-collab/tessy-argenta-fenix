...
Use template from `E:/tessy-argenta-fenix/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/tessy-argenta-fenix/.claude/get-shit-done/templates/UI-SPEC.md`
