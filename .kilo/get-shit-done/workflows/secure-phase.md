...
```
Task(
  prompt="Read E:/tessy-argenta-fenix/.kilo/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `E:/tessy-argenta-fenix/.kilo/get-shit-done/templates/SECURITY.md`
