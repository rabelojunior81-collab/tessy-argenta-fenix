...
- Generates `./.kilo/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.kilo/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `E:/tessy-argenta-fenix/.kilo/notes/` globally)
