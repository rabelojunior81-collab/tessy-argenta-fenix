...
global: `E:/tessy-argenta-fenix/.kilo/`, `~/.config/opencode/`, `~/.opencode/`, `~/.gemini/`, `~/.config/kilo/`, or `~/.codex/`
...
```bash
# RUNTIME_DIR is the resolved config directory (e.g. ~/.config/kilo, ~/.config/opencode)
