// ============================================================================
// OpenRouterProvider — @rabeluslab/inception-provider-openrouter
// ============================================================================
//
// Routes requests through OpenRouter (https://openrouter.ai), which proxies
// to 200+ models via a single OpenAI-compatible endpoint.
 ...
 * - Vision: yes
 * - Embeddings: no (OpenRouter does not expose an embeddings endpoint)
 */
export class OpenRouterProvider implements IProvider {
  ...
  async initialize(config: ProviderConfig): Promise<void> {
    ...
    this.client = new OpenAI({
      ...
      defaultHeaders: {
        'HTTP-Referer': 'https://github.com/rabeluslab/inception',
        'X-Title': 'Inception Framework',
      },
    });
  }
