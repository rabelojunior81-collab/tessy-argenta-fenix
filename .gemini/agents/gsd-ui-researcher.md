...
Use template from `E:/tessy-argenta-fenix/.gemini/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/tessy-argenta-fenix/.gemini/get-shit-done/templates/UI-SPEC.md`
