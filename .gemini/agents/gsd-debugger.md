...
<required_reading>
@E:/tessy-argenta-fenix/.gemini/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@E:/tessy-argenta-fenix/.gemini/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/tessy-argenta-fenix/.gemini
                  → checks E:/tessy-argenta-fenix/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/tessy-argenta-fenix/.gemini/get-shit-done
                  → writes to E:/tessy-argenta-fenix/.gemini/get-shit-done/hooks/
...
@E:/tessy-argenta-fenix/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/tessy-argenta-fenix/.gemini/get-shit-done/references/common-bug-patterns.md
