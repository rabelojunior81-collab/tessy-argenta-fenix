...
```markdown
Read E:/tessy-argenta-fenix/.gemini/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/tessy-argenta-fenix/.gemini/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/tessy-argenta-fenix/.gemini/agents/gsd-ui-checker.md for instructions.
