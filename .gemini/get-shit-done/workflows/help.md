...
- Generates `./.gemini/skills/spike-findings-[project]/` with references and sources
...
- Generates `./.gemini/skills/sketch-findings-[project]/` with design decisions, CSS patterns, HTML structures
...
- Saves timestamped note to `.planning/notes/` (or `E:/tessy-argenta-fenix/.gemini/notes/` globally)
