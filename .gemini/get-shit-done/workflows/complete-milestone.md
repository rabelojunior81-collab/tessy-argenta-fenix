...
```bash
node "E:/tessy-argenta-fenix/.gemini/get-shit-done/bin/gsd-tools.cjs" audit-open 2>/dev/null
```
...
**If doesn't exist:** Create from template at `E:/tessy-argenta-fenix/.gemini/get-shit-done/templates/retrospective.md`.
