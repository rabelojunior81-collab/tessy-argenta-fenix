...
SPIKE_SKILL=$(ls ./.codex/skills/spike-findings-*/SKILL.md 2>/dev/null | head -1)

# Check for sketch findings skill (project-local)
SKETCH_SKILL=$(ls ./.codex/skills/sketch-findings-*/SKILL.md 2>/dev/null | head -1)
...
**Otherwise** (the agent runtime with AskUserQuestion): use multiSelect:
...
Use template: E:/tessy-argenta-fenix/.codex/get-shit-done/templates/research-project/STACK.md
</output>
...
Use template: E:/tessy-argenta-fenix/.codex/get-shit-done/templates/research-project/FEATURES.md
</output>
...
Use template: E:/tessy-argenta-fenix/.codex/get-shit-done/templates/research-project/ARCHITECTURE.md
</output>
...
Use template: E:/tessy-argenta-fenix/.codex/get-shit-done/templates/research-project/PITFALLS.md
</output>
...
Use template: E:/tessy-argenta-fenix/.codex/get-shit-done/templates/research-project/SUMMARY.md
