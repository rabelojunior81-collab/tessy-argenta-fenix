...
```markdown
Read E:/tessy-argenta-fenix/.codex/agents/gsd-ui-researcher.md for instructions.
...
Template: E:/tessy-argenta-fenix/.codex/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read E:/tessy-argenta-fenix/.codex/agents/gsd-ui-checker.md for instructions.
