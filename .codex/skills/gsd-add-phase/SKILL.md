...
<execution_context>
@E:/tessy-argenta-fenix/.codex/get-shit-done/workflows/add-phase.md
</execution_context>
...
<process>
**Follow the add-phase workflow** from `@E:/tessy-argenta-fenix/.codex/get-shit-done/workflows/add-phase.md`.
