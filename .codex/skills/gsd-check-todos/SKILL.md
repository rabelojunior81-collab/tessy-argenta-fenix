...
<execution_context>
@E:/tessy-argenta-fenix/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@E:/tessy-argenta-fenix/.codex/get-shit-done/workflows/check-todos.md`.
