...
<execution_context>
@E:/tessy-argenta-fenix/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@E:/tessy-argenta-fenix/.codex/get-shit-done/workflows/add-todo.md`.
